...
- **NATO Military Symbols** - Equipment symbols and unit symbols following APP-6 / MIL-STD-2525 conventions, with echelon markers and optional left/right text labels
...
- **No Fill Option** - Transparent fill swatch for drawing outlines-only shapes
- **Live Style Editing** - Selecting a placed object syncs the Style Panel and lets you change its color, opacity, stroke, and scale in real time
- **Object Style Popover** - Click any placed object to open a contextual popover with Delete and filtered style controls anchored at that location
...
- **MGRS Center-On Input** - Type any MGRS coordinate and press Go to re-center the map there
...
- **Undo/Redo** - Full undo/redo support for all map actions (including per-object style changes)
...
2. **Open in a browser**
   ...
   Simply open `index.html` in any modern web browser, or serve it from any static file server. The Google Maps API key is included.
